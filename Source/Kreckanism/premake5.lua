...
project "Kreckanism"
    ...
    filter "system:linux"
        ...
        links { "glfw", "glad", "imgui", "fmt", "GL", "rt", "m", "dl", "X11", "pthread", "fbxsdk", "xml2", "fmod", "fmodstudio" }
    ...
    filter "system:windows"
        ...
        links { "glfw", "glad", "imgui", "opengl32", "libfbxsdk-md", "libxml2-md", "zlib-md", "fmodL_vc", "fmodstudioL_vc", "fsbank_vc" }
